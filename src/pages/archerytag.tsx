...
const Archerytag = () => {
  ...
  return (
    <>
      ...
      <GenericHero
        bgColor={
          "linear-gradient(to top, rgba(191,69,1,0.2) 80%, rgba(33, 34, 38, 0.1) 100%)"
        }
        ...
        subTitle={
          "Rejouez le meilleur d’Hunger Games dans une partie d’ArcheryTag, le tir de flèches en mousse.. Ferez-vous gagner votre équipe près du Hainaut ?"
        }
      />
            ...
            <div className="row">
              <div className={"col-md-6 description_box"}>
                <p>
                  ...
                  partez affronter en équipe vos adversaires avec détermination
                  et courage.
                </p>
                <p>
                  À l’issue de la partie, il n’en restera qu’un. Votre passeport
                  pour la victoire ? Un arc, des flèches en mousse, une bonne
                  maîtrise de votre arme arc, et surtout votre intelligence. Car
                  ici c’est sur des cibles mouvantes que vous allez tirer!
                  Comment les déloger, viser et tirer dans un même mouvement ?
                </p>
                <p>
                  Comment ne pas atteindre votre propre équipe ? Et comment vous
                  protéger des ennemis ? Autant de défis amusants et pleins
                  d’adrénaline que vous saurez relever.
                </p>
              </div>
              <div className={"col-md-6"}>
                <GenericDoubleImages img={arrows.src} circlesColors={""} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id={"activity"} className={"container-fluid"} style={style}>
        ...
        >
          <div className="row content">
            ...
            <div className="col-md-6">
              <p>
                Avant de vous lancer dans l’aventure, découvrez les avis et les
                récits de ceux qui vous auront précédé,sur Google.
              </p>
              <p>
                Leurs notes moyennes de 4,8 sur 5, leur enthousiasme et leur
                fidélité nous conduisent à toujours chercher à améliorer
      ...
      <section id={"activity"} className={"container-fluid"} style={style}>
        ...
        >
          <div className="row content">
            <div className="col-md-6">
              <p>
                Vous aurez mille raisons de vous lancer dans une séance
                d’ArcheryTag. Au-delà de son originalité - nous sommes les seuls
                à la proposer dans notre région-, si vous cherchez tout
                simplement à rencontrer d’autres passionnés de jeux réels, vous
                n’aurez aucun mal à vous intégrer dans une équipe.
              </p>
              <p>
                C’est l’activité idéale pour un anniversaire en famille ou entre
                amis, un enterrement de vie de garçon ou de jeune fille ou
                encore une séance de teambuilding d’entreprise. Et tout
                simplement pour passer une excellente journée avec ses amis.
              </p>
              <p>
                C’est l’activité idéale pour un anniversaire en famille ou entre
                amis, un enterrement de vie de garçon ou de jeune fille ou
