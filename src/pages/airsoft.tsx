          ...
          <div className={"container"}>
            <div className="row">
              <div className={"col-md-6 description_box"}>
                <p>
                  Vous commencerez par former vos équipes et fixer les objectifs
                  selon les scénarios proposés . Puis vous pourrez donner libre
                  cours à votre imagination et à vos aptitudes physiques. !
                </p>
                <p>
                  C’est l’activité idéale pour un enterrement de vie de garçon,
                  pleine de fun et d’adrénaline nous vous offrirons le scénario
                  du LAPINOU
                </p>
                <p>
                  C’est aussi une façon efficace d’organiser une séance de
                  teambuilding : rien de tel qu’un peu de bon stress et la mise
                  en place de stratégie d'équipe pour consolider la cohésion de
                  vos collaborateurs !
                </p>
              </div>
          ...
          <div className="row content">
            ...
            <div className="col-md-6">
              <p>
                ...
                d’airsoft - vous pouvez apporter la vôtre ou en emprunter une
                dans notre vaste choix -, vous commencerez par{" "}
                <strong>
              ...
              <p>
                Puis vous pourrez donner libre cours à votre imagination et à
                vos aptitudes physiques. N’ayez crainte,{" "}
                <strong>
                  les billes en plastique des armes factices ne vous causeront
                  aucune blessure
                </strong>
                 !
              </p>
              <p>
                C’est l’activité idéale pour en enterrement de vie de garçon,
                pleine de fun et d’adrénaline. C’est aussi une façon efficace
                d’organiser une séance de teambuilding : rien de tel qu’un peu
                de bon stress pour consolider la cohésion de vos
                collaborateurs !
              </p>
            </div>
          </div>
