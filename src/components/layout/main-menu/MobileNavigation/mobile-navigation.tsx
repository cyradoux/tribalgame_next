...
const MobileNavigation = () => {
    ...
    return (
        <>
            ...
            <div className={`offcanvas offcanvas-end ${isOpen ? "show" : ""}`} id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style={{backgroundColor: "rgba(0,0,0,1)", backgroundImage: `url(${bg.src})`}}>
                ...
                <div className="offcanvas-body">
                    <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li className="nav-item">
                            <Link onClick={handleClickMobileMenu} className="nav-link" href="/airsoft">Airsoft</Link>
                        </li>

                        <li className="nav-item">
                            <Link onClick={handleClickMobileMenu} className="nav-link" href="/archerytag">Archery-tag</Link>
                        </li>

                        <li className="nav-item">
                            <Link onClick={handleClickMobileMenu} className="nav-link" href="/lasergame">Lasergame</Link>
                        </li>

                        <li className="nav-item">
                            <Link onClick={handleClickMobileMenu} className="nav-link" href="/paintball">Paintball</Link>
                        </li>
