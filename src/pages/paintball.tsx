...
const Paintball = () => {
  ...
  return (
    <>
      ...
      <GenericHero
        bgColor={
          "linear-gradient(to top,rgba(33, 34, 38, 0.1) 0%, rgba(255,0,0,0.1) 100%)"
        }
        ...
        duration={"55min"}
        title={
          "100% Fun-100% Adrénaline et cris de joie : jouez au paintball près de Tournai"
        }
        subTitle={
          "Rires et sensations extrêmes adrénaline se mêlent lors d’incroyables parties de paintball chez Tribal Games, entre proche de Ath, Mons, Mouscron et la en Wallonie. Sensations extrêmes entre amis au programme d’un après-midi de Paintball "
        }
      />
          ...
          <div className={"container"}>
            <div className="row">
              <div className={"col-md-6 description_box"}>
                <p>
                  Vous aimez les jeux vidéo et tirer sur tout ce qui bouge ? Et
                  si vous partiez vivre une aventure dans la réalité, sans
                ...
                <p>
                  ...
                  réjouissants. Avec des amis ou accompagné.e de votre chéri.e,
                  lancez-vous dans un univers ludique et passionnant !
                </p>
                <p>
                  Imaginez : un terrain de jeu de 40 000 mètres carrés, des
                  équipes dispersées dans les bois et la nature. À vous de mener
                  votre équipe à la victoire !
                </p>
              </div>
              <div className={"col-md-6"}>
                <GenericDoubleImages img={ball.src} circlesColors={""} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id={"activity"} className={"container-fluid"} style={style}>
        ...
        >
          <div className="row content">
            ...
            <div className="col-md-6">
              <p>
                Avec votre fusil lanceur et vos centaines de balles de peinture,
                lancez-vous au sein d’une équipe constituée d’amis à la
                poursuite de vos adversaires. Le paintball, c’est plus qu’une
                traque ou un combat sans merci.
              </p>
              <p>
                C’est surtout un grand champ de bataille parsemé d’obstacles, de
                pièges, d’où un ennemi peut surgir à tout moment. Muni de votre
                combinaison intégrale et de votre masque, vous ne risquez rien…
                sauf l’élimination !
              </p>
              <p>
                Soyez plus malin que ceux de l’équipe d’en face. Toujours sur
                vos gardes, développez une stratégie gagnante, entre prudence et
                bravoure.
              </p>
            </div>
          </div>
      ...
      <section id={"activity"} className={"container-fluid"} style={style}>
        ...
        >
          <div className="row content">
            <div className="col-md-6">
              <p>
                Pourquoi vous lancer dans une partie de paintball ? Demandez-le
                aux dizaines de milliers de joueurs qui vous ont précédé.
                Retrouvez leurs avis sur Google.
              </p>
              <p>
                Ils ont apprécié la performance sportive, les rires et les
                frayeurs entre amis, le terrain de jeu incroyablement vaste… Que
                ce soit lors d’une séance de teambuilding, d’un anniversaire.
              </p>
              <p>
                C’est l’activité idéale pour un enterrement de vie de garçon ou
                de filles, pleine de fun et d’adrénaline nous vous offrirons le
                scénario du LAPINOU ou d’une sortie entre amis, vous ne serez
                pas déçu !
              </p>
            </div>
