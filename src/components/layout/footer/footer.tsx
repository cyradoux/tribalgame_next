            ...
            <div className={"row footer_top_row"}>
              <div className={`col-lg-4 col-md-6 footer_links`}>
                ...
                <div className={"tribal_coor"}>
                  <p>06 07 24 46 35</p>
                  <p>contact@tribal-games.com</p>
                  <p>Chemin d&apos;Antoing - 7500 Tournai - Belgique</p>
                  <p><Link href={"/mensions-legales"}>Mensions legales</Link></p>
                </div>
              </div>
                ...
                <div className={"footer_logos_box"}>
                  ...
                  <ul className={"tribal_socials"}>
                    <li className={"tribal_socials_li"}>
                      <Link
                        className={"tribal_socials_li_a"}
                        href="https://www.facebook.com/tribalofficiel"
                        target="_blank"
                      >
                        <i
                          className={`ri-facebook-circle-line ${"tribal_socials_li_a_i"}`}
                        ></i>
                      </Link>
                    </li>
                    <li className={"tribal_socials_li"}>
                      <Link
                        className={"tribal_socials_li_a"}
                        href="https://www.youtube.com/@saint-quentinbasketball7185"
                        target="_blank"
                      >
                        <i
                          className={`ri-youtube-line ${"tribal_socials_li_a_i"}`}
                        ></i>
                      </Link>
                    </li>
                    <li className={"tribal_socials_li"}>
                      <Link
                        className={"tribal_socials_li_a"}
                        href="https://www.instagram.com/tribalofficiel/"
                        target="_blank"
                      >
                        <i
                          className={`ri-instagram-line tribal_socials_li_a_i`}
                        ></i>
                      </Link>
                    </li>
                  </ul>
              ...
              <div className="col-12" style={{ textAlign: "center" }}>
                <div className={"footer_contact_p"}>
                  ...
                  . Tous droits réservés. Crée par{" "}
                  <a href="https://0001-communication.fr/">
                    0001 Communication
                  </a>
                </div>
              </div>
